...
impl Machine {
    pub(crate) fn execute(&mut self) {
        ...
        match opcode {
            ...
            Opcode::LdBB => self.load_register_into_register(|regs| (regs.b, &mut regs.b)),
            Opcode::LdBC => self.load_register_into_register(|regs| (regs.c, &mut regs.b)),
            Opcode::LdBD => self.load_register_into_register(|regs| (regs.d, &mut regs.b)),
            Opcode::LdBE => self.load_register_into_register(|regs| (regs.e, &mut regs.b)),
            Opcode::LdBH => self.load_register_into_register(|regs| (regs.h, &mut regs.b)),
            Opcode::LdBL => self.load_register_into_register(|regs| (regs.l, &mut regs.b)),
            Opcode::LdBHL => self.load_memory_into_register(|regs| (regs.h, regs.l), |regs| &mut regs.b),
            Opcode::LdBA => self.load_register_into_register(|regs| (regs.a, &mut regs.b)),

            Opcode::LdCB => self.load_register_into_register(|regs| (regs.b, &mut regs.c)),
            Opcode::LdCC => self.load_register_into_register(|regs| (regs.c, &mut regs.c)),
            Opcode::LdCD => self.load_register_into_register(|regs| (regs.d, &mut regs.c)),
            Opcode::LdCE => self.load_register_into_register(|regs| (regs.e, &mut regs.c)),
            Opcode::LdCH => self.load_register_into_register(|regs| (regs.h, &mut regs.c)),
            Opcode::LdCL => self.load_register_into_register(|regs| (regs.l, &mut regs.c)),
            Opcode::LdCHL => self.load_memory_into_register(|regs| (regs.h, regs.l), |regs| &mut regs.c),
            Opcode::LdCA => self.load_register_into_register(|regs| (regs.a, &mut regs.c)),

            Opcode::LdDB => self.load_register_into_register(|regs| (regs.b, &mut regs.d)),
            Opcode::LdDC => self.load_register_into_register(|regs| (regs.c, &mut regs.d)),
            Opcode::LdDD => self.load_register_into_register(|regs| (regs.d, &mut regs.d)),
            Opcode::LdDE => self.load_register_into_register(|regs| (regs.e, &mut regs.d)),
            Opcode::LdDH => self.load_register_into_register(|regs| (regs.h, &mut regs.d)),
            Opcode::LdDL => self.load_register_into_register(|regs| (regs.l, &mut regs.d)),
            Opcode::LdDHL => self.load_memory_into_register(|regs| (regs.h, regs.l), |regs| &mut regs.d),
            Opcode::LdDA => self.load_register_into_register(|regs| (regs.a, &mut regs.d)),

            Opcode::LdEB => self.load_register_into_register(|regs| (regs.b, &mut regs.e)),
            Opcode::LdEC => self.load_register_into_register(|regs| (regs.c, &mut regs.e)),
            Opcode::LdED => self.load_register_into_register(|regs| (regs.d, &mut regs.e)),
            Opcode::LdEE => self.load_register_into_register(|regs| (regs.e, &mut regs.e)),
            Opcode::LdEH => self.load_register_into_register(|regs| (regs.h, &mut regs.e)),
            Opcode::LdEL => self.load_register_into_register(|regs| (regs.l, &mut regs.e)),
            Opcode::LdEHL => self.load_memory_into_register(|regs| (regs.h, regs.l), |regs| &mut regs.e),
            Opcode::LdEA => self.load_register_into_register(|regs| (regs.a, &mut regs.e)),

            Opcode::LdHB => self.load_register_into_register(|regs| (regs.b, &mut regs.h)),
            Opcode::LdHC => self.load_register_into_register(|regs| (regs.c, &mut regs.h)),
            Opcode::LdHD => self.load_register_into_register(|regs| (regs.d, &mut regs.h)),
            Opcode::LdHE => self.load_register_into_register(|regs| (regs.e, &mut regs.h)),
            Opcode::LdHH => self.load_register_into_register(|regs| (regs.h, &mut regs.h)),
            Opcode::LdHL => self.load_register_into_register(|regs| (regs.l, &mut regs.h)),
            Opcode::LdHHL => self.load_memory_into_register(|regs| (regs.h, regs.l), |regs| &mut regs.h),
            Opcode::LdHA => self.load_register_into_register(|regs| (regs.a, &mut regs.h)),

            Opcode::LdLB => self.load_register_into_register(|regs| (regs.b, &mut regs.l)),
            Opcode::LdLC => self.load_register_into_register(|regs| (regs.c, &mut regs.l)),
            Opcode::LdLD => self.load_register_into_register(|regs| (regs.d, &mut regs.l)),
            Opcode::LdLE => self.load_register_into_register(|regs| (regs.e, &mut regs.l)),
            Opcode::LdLH => self.load_register_into_register(|regs| (regs.h, &mut regs.l)),
            Opcode::LdLL => self.load_register_into_register(|regs| (regs.l, &mut regs.l)),
            Opcode::LdLHL => self.load_memory_into_register(|regs| (regs.h, regs.l), |regs| &mut regs.l),
            Opcode::LdLA => self.load_register_into_register(|regs| (regs.a, &mut regs.l)),
            ...
            Opcode::LdAB => self.load_register_into_register(|regs| (regs.b, &mut regs.a)),
            Opcode::LdAC => self.load_register_into_register(|regs| (regs.c, &mut regs.a)),
            Opcode::LdAD => self.load_register_into_register(|regs| (regs.d, &mut regs.a)),
            Opcode::LdAE => self.load_register_into_register(|regs| (regs.e, &mut regs.a)),
            Opcode::LdAH => self.load_register_into_register(|regs| (regs.h, &mut regs.a)),
            Opcode::LdAL => self.load_register_into_register(|regs| (regs.l, &mut regs.a)),
            Opcode::LdAHL => self.load_memory_into_register(|regs| (regs.h, regs.l), |regs| &mut regs.a),
            Opcode::LdAA => self.load_register_into_register(|regs| (regs.a, &mut regs.a)),
